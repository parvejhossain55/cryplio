...
func (m *MockWalletService) Withdraw(ctx context.Context, userID uuid.UUID, cryptoSymbol, destination string, amount float64, fee float64, memo *string) (*wallet.WalletTransaction, error) {
	return nil, nil
}
