...
type PlatformRepository interface {
	...
	GetCryptoAssets(ctx context.Context, activeOnly bool, searchQuery string, limit, offset int) ([]*CryptoAsset, int, error)
	...
	GetFiatCurrencies(ctx context.Context, activeOnly bool, searchQuery string, limit, offset int) ([]*FiatCurrency, int, error)
	...
	GetPaymentMethods(ctx context.Context, activeOnly bool, searchQuery string, limit, offset int) ([]*PaymentMethod, int, error)
