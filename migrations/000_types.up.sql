...
CREATE TYPE notification_type AS ENUM ('trade_started', 'trade_paid', 'trade_released', 'trade_cancelled', 'trade_disputed', 'dispute_resolved', 'new_message', 'deposit_received', 'withdrawal_completed', 'merchant_approved', 'referral_earned', 'system_announcement');
CREATE TYPE admin_action_type AS ENUM ('user_suspend', 'user_ban', 'user_unban', 'dispute_resolve', 'withdrawal_approve', 'withdrawal_reject', 'announcement_post', 'fee_update', 'merchant_approve', 'merchant_reject', 'config_change', 'bulk_message', 'report_generate');
